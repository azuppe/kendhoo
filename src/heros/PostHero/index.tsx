      ...
      <div className="relative z-10 px-0 md:px-6 -mt-16 md:-mt-24">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6 mb-4">
          ...
          <div className="flex items-center gap-4 mt-2 md:mt-0">
            ...
            {/* Actions */}
            <button className="ml-2 px-3 py-1 rounded-full border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 text-sm font-medium transition">Save to pocket</button>
            <button className="px-3 py-1 rounded-full border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 text-sm font-medium transition">Share on media</button>
          </div>
        </div>
      </div>
    </div>
